...
| `logTail`                                             | Last 200 lines of runner stdout, secret-stripped and capped at 16 KB. Empty when `pods/log` RBAC is missing.                                                                                                                                               |
| `logError`                                            | Why `logTail` is empty. A `403` here means the Role is missing `pods/log` `get`, see the deployment RBAC.                                                                                                                                                  |
