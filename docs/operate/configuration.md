...
Selects the system/user prompt split the agent executor passes to the Claude Agent SDK. See `src/config.ts:763#promptCacheLayout` for the Zod definition and `src/core/executor.ts:231#useCacheableLayout` for the runtime guard.
